...
export const unicellInfo: UnicellInfo[] = [
  {
    ...
    image: "/initial_assets/unicell_1.png",
...

  {
    ...
    image: "/initial_assets/unicell_2.png",
    position: { x: '70%', y: '45%' },
    size: 40,
    floatDuration: 2.2
  },

  {
    ...
    image: "/initial_assets/unicell_3.png",
    position: { x: '85%', y: '20%' },
    size: 50,
    floatDuration: 2.8
  },

  {
    ...
    image: "/initial_assets/unicell_4.png",
    position: { x: '50%', y: '75%' },
    size: 50,
    floatDuration: 3.0
  },

  {
    ...
    image: "/initial_assets/unicell_5.png",
    position: { x: '85%', y: '70%' },
    size: 45,
    floatDuration: 2.0
  }
